...
For pricing of all of these endpoints, please refer to our [pricing page](../getting-started/pricing-and-billing.mdx).
...
- See the pricing and context limits for any selected model.
  ![](https://www.datocms-assets.com/45680/1711724083-textgen-demo.png?max-w=2000&auto=compress)
...
When you're ready to start calling the endpoint programmatically, check out our [REST API](rest-api.mdx), [Python SDK](python-sdk.mdx), and [Typescript SDK](typescript-sdk.mdx) docs.
