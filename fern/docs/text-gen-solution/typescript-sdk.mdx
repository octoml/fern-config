...
These are the values that you can put in the `model` field in either your [chat completion creation requests](https://octoml.github.io/octoai-typescript-sdk/classes/ChatCompletionCreateRequest.html) or [completion requests](https://octoml.github.io/octoai-typescript-sdk/types/CreateCompletionRequest.html).
