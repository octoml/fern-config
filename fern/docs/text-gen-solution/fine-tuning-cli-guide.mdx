...
6. **weight and bias parameters** (optional): Enable with "--wandb-project-name" and "--wandb-secret-key”. To use this feature, sign up for [Weights and Biases](https://wandb.ai/site) and follow the [Weights & Biases Setup Guide](/docs/integrations/weights-and-biases).
