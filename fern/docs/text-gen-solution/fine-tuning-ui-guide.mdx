...
After completing all the required information and clicking on “Start Tuning”, you can see the fine-tuning jobs on the [Fine-tunes](https://octoai.cloud/tuning) page.

![](../assets/images/fine-tuning-imgs/ui-guide/fine-tuning-UI-3.png)

## 3. Inference with your LoRA

On the [Fine-tunes](https://octoai.cloud/tuning) page, when you click on a certain fine-tuning job, there is a “Test it” button. Click on that button, it will navigate you to the Inference Page with your LoRA loaded.
...
![](../assets/images/fine-tuning-imgs/ui-guide/fine-tuning-inference-2.jpeg)
