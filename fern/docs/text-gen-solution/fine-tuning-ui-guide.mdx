| title | subtitle | slug |
| --- | --- | --- |
| Text Gen Fine-tuning  | Create custom assets with OctoAI's fine-tuning of Text Gen models. | text-gen-solution/fine-tuning/fine-tuning-ui-guide
...
On the “Fine-tune” Page, when you click on a certain “Fine-tune” job, there is a “Try it” button, which navigates you to the Inference page.
...
![Untitled](../assets/images/fine-tuning-imgs/ui-guide/fine-tuning-inference-3.jpeg)
