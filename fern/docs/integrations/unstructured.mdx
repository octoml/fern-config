...
Before you get started let's review some concepts. You will need an [OctoAI API Token](/getting-started/how-to-create-an-octoai-access-token) for this integration.
