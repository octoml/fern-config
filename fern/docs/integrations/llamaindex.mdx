...
```
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://github.com/ytang07/ai_agents_cookbooks/ =x32)
[![Open in Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/ytang07/ai_agents_cookbooks/ =x32)
...
```
[![Open in Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/octoml/octoai-textgen-cookbook  =x32)
