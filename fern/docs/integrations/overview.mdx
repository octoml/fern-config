...
<CardGroup cols={2}>
  <Card href="langchain">
    ...
    <Card href="botdojo">
    <img src="../assets/logos/botdojo-logo.svg" noZoom />
    <span className="title">BotDojo/span>
    OctoAI provides optimized Large Language Model (LLM) and Embedding endpoints
    for scalable, private, and cost-effective deployments.
  </Card>
