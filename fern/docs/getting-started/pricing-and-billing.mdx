...
See [rate limits](../faqs/rate-limits) for details, and feel free to [contact us](https://octo.ai/contact-us/) to discuss higher limits to meet your needs. You will recieve an HTTP 429 response code if you reach the limit cap.
