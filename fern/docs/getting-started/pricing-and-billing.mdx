...
See [rate limits](../faqs/rate-limits.mdx) for details, and feel free to [contact us](https://octo.ai/contact-us/) to discuss higher limits to meet your needs. You will recieve an HTTP 429 response code if you reach the limit cap.
...
| Premium Samplers: DPM\_2, DPM\_2\_ANCESTRAL, DPM\_PLUS\_PLUS\_SDE\_KARRAS, HEUN, KLMS | Default price \*2                  |
