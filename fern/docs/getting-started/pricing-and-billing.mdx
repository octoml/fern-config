...
| Juggernaut v9 and XI                          | 30    | all supported | N/A                                        | $0.01/image                                     |
...
| Llama 3.1 70B model fine-tuning  | $3.00* |

*The cost for fine-tuning training is calculated per epoch per million tokens. After your fine-tunes, the price for LoRA inference will be the same cost as the base model inference with no extra fees. 
