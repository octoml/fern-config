...
1. [Sign up for an account](https://identity.octoml.ai/oauth/account/sign-up?redirectUrl=https://octoai.cloud) - new users get $10 of free credits
...
![](https://www.datocms-assets.com/45680/1712261559-quickstart-curl-example1.png?max-w=2000&auto=compress)
...
- Explore [our tutorials](../tutorials/image-generation-application-e2e-example.mdx) and [demos](https://octo.ai/demos/) to see OctoAI in action.
