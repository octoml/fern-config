...
OctoAI currently supports the self-service models & checkpoints organized on this page, and we’ll continue to expand our models and services. Ready to run your first inference? [Navigate to our Quickstart guide to get started.](quickstart.mdx)
...
Check out our [REST API](../text-gen-solution/rest-api.mdx), [Python SDK](../text-gen-solution/python-sdk.mdx), or [TypeScript SDK](../text-gen-solution/typescript-sdk.mdx) docs when you’re ready to use text gen models programmatically. 
...
Check out our [Image Gen API](../media-gen-solution/rest-apis/image-gen-api.mdx) and [Video Gen API](../media-gen-solution/rest-apis/video-gen.mdx) docs when you’re ready to use media gen models programmatically. You can also easily upload and run custom checkpoints and assets using OctoAI’s [Asset Library.](../media-gen-solution/uploading-a-custom-asset-to-the-octoai-asset-library.mdx) 
