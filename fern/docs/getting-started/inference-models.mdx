...
Check out our [REST API](../text-gen-solution/rest-api), [Python SDK](../text-gen-solution/python-sdk), or [TypeScript SDK](../text-gen-solution/typescript-sdk) docs when you’re ready to use text gen models programmatically.
...
Check out our [Image Gen API](../media-gen-solution/rest-apis/image-gen-api) and [Video Gen API](../media-gen-solution/rest-apis/video-gen) docs when you’re ready to use media gen models programmatically. You can also easily upload and run custom checkpoints and assets using OctoAI’s [Asset Library.](../media-gen-solution/uploading-a-custom-asset-to-the-octoai-asset-library)
