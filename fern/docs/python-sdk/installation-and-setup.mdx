...
In order to access endpoints, [create an OctoAI API token](../getting-started/how-to-create-an-octoai-access-token.mdx). Set `OCTOAI_TOKEN` to the token value wherever you set your environment variables, such as your `.bashrc` or `.env` file.
