...
Please refer to [CLI & SDK Installation](/docs/bring-your-own-model/cli-and-sdk-installation) for how to install the SDK in conjunction with the CLI for the authoring tool.
