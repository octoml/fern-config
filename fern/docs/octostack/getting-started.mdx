...
OctoAI will provide an auth token which will be used to pull container images, and a `docker-compose.yaml` file that will contain the necessary configuration for your chosen model and the hardware that you'll host on.
...
OctoAI will provide an auth token which will be used to pull container images, and a Helm chart project will contain the necessary configuration for your chosen model and the hardware that you'll host on.
