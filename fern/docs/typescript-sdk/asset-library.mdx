...
The AssetLibrary client in the TypeScript SDK allows `create`, `list`, `get`, and `delete` actions of assets. These assets allow integration with [Fine-tuning Stable Diffusion](/docs/api-reference/fine-tuning/create-tune).
