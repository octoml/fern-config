...
- **Select hardware:** We offer three tiers of hardware-- see [Hardware, Pricing, and Billing](../../getting-started/pricing-and-billing) for more information. Your choice of hardware determines the pricing that you will pay for your endpoint.
...
- You need to edit the curl to use your own API token. If you don't have an existing token, refer to [how to create an OctoAI API Token](../../getting-started/how-to-create-an-octoai-access-token)
