...
- [REST API](/docs/api-reference/octoai-api/inference)
- [Python SDK](/docs/python-sdk/python-sdk-inferences)
- [TypeScript SDK](/docs/typescript-sdk/typescript-sdk-inferences)
