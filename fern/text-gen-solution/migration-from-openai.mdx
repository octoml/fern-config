...
- Get an OctoAI API token by following [these instructions](/getting-started/how-to-create-an-octoai-access-token/).
...
Note that you need to supply one of OctoAI's supported LLMs as an argument, as in the example above. For a complete list of our supported LLMs, check out our [REST API page](/text-gen-solution/rest-api#input-parameters).
